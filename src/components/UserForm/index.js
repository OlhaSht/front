    ...
    return (
        ...
        >{
            formikProps=>
                ...
                <input name="imgPath" placeholder="imgPath" type="file"
                       onChange={({target})=>formikProps.setFieldValue('imgPath', target.files[0])}/>
...
//служит для корректной отправки файлов на сервер при работе с полями <input type="file"> 
